package com.examplesky.vnoteappv.Adapters;
...
import com.examplesky.vnoteappv.NotesClickListener;
import com.examplesky.vnoteappv.R;
...
public class NotesListAdapter extends RecyclerView.Adapter<NotesViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NotesViewHolder holder, int position) {
       ...
       // holder.note_container.setCardBackgroundColor(holder.itemView.getResources().getColor(color_code));//van de
